...
CREATE TABLE `users` (
  ...
  `role` enum('student','teacher','admin_langganan','admin_sekolah') NOT NULL,
...
INSERT INTO `attendance` (`id`, `student_id`, `date`, `status`, `subject`, `check_in_time`, `location`, `notes`) VALUES
