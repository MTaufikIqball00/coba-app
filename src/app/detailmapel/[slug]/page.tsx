...
import { getAllCourses, getCourse } from "../../../app/api/modules/store"; // Corrected path
...
// Generate static params by directly accessing the data
...
export default async function DetailMataPelajaranPage({ params }: PageProps) {
  ...
  // Adapt the data for the CurriculumAccordion
  const curriculum = {
    pendahuluan: course.modules[0]?.lessons || [],
    penguasaan: course.modules[1]?.lessons || [],
    // You can extend this logic if you have more sections
  };
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between mb-6">
                <div className="flex-1">
                  <h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-cyan-300 mb-4 leading-tight">
                    {course.title}
                  </h1>
                  <p className="text-blue-100/90 text-lg mb-6 leading-relaxed max-w-2xl">
                    {course.description}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-6 text-center border border-blue-400/30 hover:border-blue-400/50 transition-all duration-300 hover:scale-105">
                  <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-xl flex items-center justify-center">
                    <svg
                  ...
                  <div className="text-2xl font-bold text-white mb-1">
                    {/* Duration can be calculated or added to the store */}
                  </div>
                ...
                <div className="group bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl p-6 text-center border border-indigo-400/30 hover:border-indigo-400/50 transition-all duration-300 hover:scale-105">
                  <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-xl flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-white"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <div className="text-2xl font-bold text-white mb-1">
                    {/* Student count can be added to the store */}
                  </div>
                  <div className="text-blue-200/80 text-sm font-medium">
                    Siswa Aktif
                  </div>
                ...
                <div className="group bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-2xl p-6 text-center border border-emerald-400/30 hover:border-emerald-400/50 transition-all duration-300 hover:scale-105">
                  <div className="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-xl flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-white"
                      fill="none"
                      stroke="currentColor"
